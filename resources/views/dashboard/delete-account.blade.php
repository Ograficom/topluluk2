        ...
        <main class="w-full">
            <div class="relative left-1/2 right-1/2 mb-[calc(7rem+env(safe-area-inset-bottom))] min-h-[70vh] w-screen -translate-x-1/2 bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 sm:left-auto sm:right-auto sm:mb-0 sm:w-full sm:translate-x-0 sm:rounded-xl sm:border sm:border-gray-200 dark:sm:border-slate-700 sm:shadow-sm">
                ...
                <div class="px-3 pt-4 pb-6 sm:p-6 sm:pb-8">
                    <div class="mb-6 rounded-2xl border border-red-100 dark:border-red-500/30 bg-red-50 dark:bg-red-500/10 px-4 py-4">
                        <h2 class="text-base font-medium text-red-700 dark:text-red-400">
                            Hesabı Sil
                        </h2>

                        <p class="mt-1 text-sm leading-6 text-red-600 dark:text-red-400">
                            Hesabınız silindiğinde tüm verileriniz kalıcı olarak silinir.
                        </p>
                    </div>
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-4">
                        ...
                        @else
                            <div class="rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-4 py-4 text-sm leading-6 text-gray-600 dark:text-slate-400">
                                Bu uygulamada hesap silme özelliği etkin değil.
                            </div>
                        @endif
                    </div>
                </div>
