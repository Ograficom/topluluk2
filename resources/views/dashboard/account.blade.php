                ...
                <div class="px-3 pt-4 pb-6 sm:p-6 sm:pb-8">
                    ...
                    <form action="{{ route('dashboard.account.update') }}" method="POST" class="space-y-5">
                        ...
                        <div class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-4">
                            <label for="name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-slate-100">
                                Ad ve soyad
                            </label>
                        ...
                        <div class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-4">
                            <label for="username" class="mb-2 block text-sm font-medium text-gray-900 dark:text-slate-100">
                                Kullanıcı adı
                            </label>
                        ...
                        <div class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-4">
                            <label for="email" class="mb-2 block text-sm font-medium text-gray-900 dark:text-slate-100">
                                E-posta
                            </label>
