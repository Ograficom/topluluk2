...
<div class="ografi-feed-insert-assets" data-og-feed-insert-assets data-global-start="{{ $feedGlobalStart }}" hidden>
            ...
            <div class="og-feed-insert-card__list">
                @forelse($topPosts as $post)
                    ...
                    <a class="og-feed-insert-card__row" href="{{ route('blog.post', $post->slug) }}">
                        ...
                        @else
                            <span class="og-feed-insert-card__thumb og-feed-insert-card__thumb--empty" aria-hidden="true"></span>
                        @endif
                    </a>
                @empty
            ...
            <div class="og-feed-insert-card__list">
                @forelse($feedCategories as $category)
                    ...
                    <a class="og-feed-insert-card__row" href="{{ route('blog.category', $category->slug) }}">
                        ...
                        @else
                            <span class="og-feed-insert-card__avatar og-feed-insert-card__avatar--square og-feed-insert-card__avatar--empty" aria-hidden="true">
            ...
            <div class="og-feed-insert-card__list">
                @forelse($feedSuggestedUsers as $person)
                    @php
                        ...
                        $personUrl = route('users.show', $person);
                    @endphp
                    <div class="og-feed-insert-card__row og-feed-insert-card__row--person">
                        <a class="og-feed-insert-card__person-link" href="{{ $personUrl }}">
...
<style data-og-feed-insert-style>
    ...
    .home-feed-shell .og-feed-insert-card__list {
        display: flex;
    ...
    .home-feed-shell .og-feed-insert-card__avatar--square {
        border-radius: 10px;
    }

    .home-feed-shell .og-feed-insert-card__thumb--empty,
    .home-feed-shell .og-feed-insert-card__avatar--empty {
        display: inline-flex;
        align-items: center;
    ...
    .home-feed-shell .og-feed-insert-card__row--person {
    ...
    .home-feed-shell .og-feed-insert-card__follow-form {
        flex: 0 0 auto;
        margin: 0;
    }
    ...
    .home-feed-shell .og-feed-insert-card__follow.is-following {
        background: #f1f2f4;
        color: #5c626b;
    }

    .home-feed-shell .og-feed-insert-card__empty {
        padding: 10px 0 4px;
        color: #747982;
        font-size: 13px;
    }
    ...
    .dark .home-feed-shell .og-feed-insert-card {
        border-color: #30343a;
        background: #17181b;
    }
    ...
    .dark .home-feed-shell .og-feed-insert-card__name {
        color: #f4f4f5;
    }
    ...
    .dark .home-feed-shell .og-feed-insert-card__empty {
        color: #a5a8ae;
    }

    html.dark .home-feed-shell .og-feed-insert-card__follow,
    .dark .home-feed-shell .og-feed-insert-card__follow {
        border-color: #3b4047;
        background: #202226;
        color: #f4f4f5;
    }
    ...
    .dark .home-feed-shell .og-feed-insert-card__follow.is-following {
        background: #2b2e33;
        color: #c7c9ce;
    }
...
(() => {
    const initOgrafiFeedInserts = () => {
        ...
        const render = () => {
            shell.querySelectorAll('[data-og-feed-insert-generated]').forEach((node) => node.remove());
