    ...
    */
    ...
    @media (min-width: 1024px) {
        body.alma-app .sidebar-wrapper:not(.sidebar-wrapper--drawer) {
            top: 86px !important;
            left: max(0px, calc((100vw - var(--layout-shell-max, 1272px)) / 2)) !important;
            transform: none !important;
