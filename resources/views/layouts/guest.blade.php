...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" href="/favicon.ico?v=20260714a" type="image/x-icon">
        <link rel="icon" href="/favicon.ico?v=20260714a" type="image/x-icon">
        <link rel="icon" href="/favicon-64.png?v=20260714a" type="image/png" sizes="64x64">
