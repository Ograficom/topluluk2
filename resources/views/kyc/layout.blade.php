...
<head>
    ...
    <title>@yield('title', __('KYC')) - {{ config('app.name') }}</title>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center space-x-6 overflow-x-auto">
                    ...
                    <a href="{{ route('kyc.index') }}" class="text-sm font-medium text-primary-600 hover:text-primary-700 transition whitespace-nowrap">
                        {{ __('KYC') }}
                        @auth
