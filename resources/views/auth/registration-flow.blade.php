<x-guest-layout>
    <style>
        ...
        html.dark .simple-auth-description-email { color: var(--alma-text, #e5e7eb); }
        ...
        html.dark .simple-auth-footer,
        html body .simple-auth-page .simple-auth-footer:not(#comments *):not(#app *) {
            color: var(--alma-text, #e5e7eb) !important;
        }
        html.dark .simple-auth-footer a,
        html.dark .simple-auth-change,
        html body .simple-auth-page .simple-auth-footer a:not(#comments *):not(#app *),
        html body .simple-auth-page .simple-auth-change:not(#comments *):not(#app *) {
            color: var(--alma-muted, #94a3b8) !important;
        }
        html.dark .simple-auth-footer a:hover,
        html.dark .simple-auth-change:hover {
            color: var(--alma-text, #e5e7eb) !important;
        }
