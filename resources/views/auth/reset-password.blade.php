<x-guest-layout>
    <style>
        ...
        html.dark .simple-auth-input[readonly] {
        ...
        html.dark .simple-auth-footer { color: var(--alma-muted, #94a3b8); }
        html.dark .simple-auth-footer a { color: var(--alma-primary, #029d71); }
