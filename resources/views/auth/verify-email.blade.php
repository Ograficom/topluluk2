<x-guest-layout>
    <style>
        ...
        html.dark .simple-auth-link:hover,
        html body .simple-auth-page .simple-auth-link:not(#comments *):not(#app *):hover {
            color: var(--alma-text, #e5e7eb) !important;
        }
        ...
        <section class="simple-auth-card" aria-label="E-posta doğrulama">
            ...
            @if (session('status') === 'verification-link-sent')
                <div role="alert" class="simple-auth-notice simple-auth-notice--success">
                    ...
                    <div>
                        <div class="simple-auth-notice__title">Kod gönderildi</div>
                        <div class="simple-auth-notice__text">Yeni doğrulama kodu e-posta adresinize gönderildi.</div>
                    </div>
                </div>
            @endif
