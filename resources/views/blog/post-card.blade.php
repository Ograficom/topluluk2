...
<svg class="post-card__bookmark-icon" viewBox="0 0 24 24" width="1.2em" height="1.2em" aria-hidden="true"><g fill="none" stroke="currentColor" stroke-width="2.1"><path class="ps-bookmark-shape" d="M21 16.09v-4.992c0-4.29 0-6.433-1.318-7.766C18.364 2 16.242 2 12 2S5.636 2 4.318 3.332S3 6.81 3 11.098v4.993c0 3.096 0 4.645.734 5.321c.35.323.792.526 1.263.58c.987.113 2.14-.907 4.445-2.946c1.02-.901 1.529-1.352 2.118-1.47c.29-.06.59-.06.88 0c.59.118 1.099.569 2.118 1.47c2.305 2.039 3.458 3.059 4.445 2.945c.47-.053.913-.256 1.263-.579c.734-.676.734-2.224.734-5.321Z"></path><path class="ps-bookmark-line" stroke-linecap="round" d="M15 6H9"></path></g></svg>
SVG;
...
SVG;
    $reactionAddIcon = <<<'SVG'
<svg class="post-card__reaction-custom-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.1" d="M18.5 3v5M21 5.5h-5m4.863 4.937a9 9 0 0 1-4.707 9.546a9 9 0 0 1-10.52-1.619a9 9 0 0 1-1.62-10.52a9 9 0 0 1 9.547-4.707m1.619 12.045a4.5 4.5 0 0 1-6.364 0M9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75S9.168 9 9.375 9s.375.336.375.75m-.375 0h.008v.015h-.008Zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75s.168-.75.375-.75s.375.336.375.75m-.375 0h.008v.015h-.008z"/></svg>
SVG;
    $editedInfoIcon = <<<'SVG'
...
>
    ...
    <div class="action-bar" id="action-bar">
        <div class="action-left" id="action-left">
            ...
            @if($isCommentsDisabled ?? false)
                <span class="action-btn action-chip action-chip--metric action-chip--disabled action-chip--subtle" aria-disabled="true">
                    <div class="post-card__inline-icon">
                        <svg class="post-card__comment-icon" viewBox="0 0 24 24" width="1.2em" height="1.2em" aria-hidden="true"><g fill="none" stroke="currentColor" stroke-linejoin="round"><path stroke-width="2.1" d="M14.17 20.89c4.184-.277 7.516-3.657 7.79-7.9c.053-.83.053-1.69 0-2.52c-.274-4.242-3.606-7.62-7.79-7.899a33 33 0 0 0-4.34 0c-4.184.278-7.516 3.657-7.79 7.9a20 20 0 0 0 0 2.52c.1 1.545.783 2.976 1.588 4.184c.467.845.159 1.9-.328 2.823c-.35.665-.526.997-.385 1.237c.14.24.455.248 1.084.263c1.245.03 2.084-.322 2.75-.813c.377-.279.566-.418.696-.434s.387.09.899.3c.46.19.995.307 1.485.34c1.425.094 2.914.094 4.342 0Z"></path><path stroke-linecap="round" stroke-width="2.2" d="M11.995 12h.01m3.986 0H16m-8 0h.009"></path></g></svg>
                    </div>
        ...
        >
            <div class="post-card__inline-icon">
                <svg class="post-card__view-icon" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.1" viewBox="0 0 24 24" aria-hidden="true"><path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7S1 12 1 12z"></path><circle cx="12" cy="12" r="3"></circle></svg>
            </div>
...
@once
    ...
    <style>
        ...
        @media (min-width: 1440px) {
            ...
            html body article.post-card[data-post-card-shell] :is(.post-summary, [data-post-card-summary], .post-card__full-content, .post-card__inline-text):not(#comments *):not(#app *) {
                font-family: Roboto, Arial, sans-serif !important;
                font-size: 17px !important;
                font-weight: 400 !important;
            ...
            html body article.post-card[data-post-card-shell] .expand-link:not(#comments *):not(#app *) {
                font-size: 16px !important;
                font-weight: 600 !important;
                line-height: 24px !important;
            }
        ...
        html.dark body article.post-card[data-post-card-shell] .post-summary-shell.is-collapsed::after {
            background: linear-gradient(180deg, rgba(17, 24, 39, 0) 0%, rgba(17, 24, 39, .9) 58%, #111827 100%) !important;
        }
    ...
    <script>
        (function () {
            ...
            const resetReactionMenuPosition = function (card) {
                ...
                panel.style.removeProperty('--reaction-transform-origin');
            ...
            const positionReactionMenu = function (card) {
                ...
                panel.style.setProperty(
                    ...
                    `${Math.round(originX)}px ${openAbove ? 'bottom' : 'top'}`
                );
            };
