...
`),"commandbar.css",!1),p.CommandBarTooltip=P,p.TOOLTIP_CLASS_NAME=d,p.BUTTON_CLASS_NAME=a}),function(){ace.require(["ace/ext/command_bar"],function(c){g&&(g.exports=c)})}()})(N);var D=N.exports;const B=V(D),Y=W({__proto__:null,default:B},[D]);export{Y as e};
