import{C as r}from"./app-ografi-fix-1577318.js";function o(a,l){for(var t=0;t<l.length;t++){const e=l[t];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in a)){const c=Object.getOwnPropertyDescriptor(e,n);c&&Object.defineProperty(a,n,c.get?c:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}))}var i={exports:{}};(function(a,l){ace.define("ace/theme/github_light_default-css",["require","exports","module"],function(t,e,n){n.exports=`.ace-github-light-default .ace_gutter {
    background: #ffffff;
...
`}),ace.define("ace/theme/github_light_default",["require","exports","module","ace/theme/github_light_default-css","ace/lib/dom"],function(t,e,n){e.isDark=!1,e.cssClass="ace-github-light-default",e.cssText=t("./github_light_default-css");var c=t("../lib/dom");c.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/github_light_default"],function(t){a&&(a.exports=t)})}()})(i);var g=i.exports;const u=r(g),d=o({__proto__:null,default:u},[g]);export{d as t};
