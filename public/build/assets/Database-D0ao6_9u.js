...
import {
	i as M
} from "./useThemeConfig-final-9c013f8.js";
		...
		setup(te) {
			...
			async function C(p, e, d, m) {
				...
				try {
					...
					console.log("License server unavailable - please try again later")
				}
			}
			const L = async () => {
				try {
				...
				["db_host", "db_port", "db_name", "db_user", "db_password"].forEach(r => {
