...
class PostVoteAssetsMiddleware
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        try {
            ...
            // Session her response katmaninda hazir olmayabilir. Vote arayuzu
            // opsiyonel oldugu icin bu katman create/edit sayfasini 500'e dusurmemeli.
            $votesEnabled = false;
            ...
            // Oylama assetleri yalnizca bir sunum katmanidir. Buradaki hata
            // ana create/edit veya post sayfasini dusurmesin; loga yazip devam et.
            report($exception);
        }
